...
Innan du börjar installera och konfigurera datainhämtningsfunktionen för AEM Forms måste du se till att:
...
1. Lägg till paketet **sun.util.calendar** i **allowlist** -fältet. Click **Save**.
