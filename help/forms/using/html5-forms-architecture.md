...
HTML 5-formulärsfunktionen distribueras som ett paket i den inbäddade AEM och visas som en REST-slutpunkt över HTTP/S med RESTful [Apache Sling Architecture](https://sling.apache.org/).
...
När en användare skickar formuläret skickar webbläsaren formulärets status i JSON-format till [skicka tjänstproxy](../../forms/using/service-proxy.md); skickar tjänstproxyn data-XML med JSON-data och skickar XML-data till slutpunkten.
...
<table>
 <tbody>
  ...
  <tr>
   <td>Aggressiv</td>
   <td>Cachelagra återgivet HTML-innehåll<br /> Cachelagra alla artefakter som cachelagrats på den konservativa nivån.<br /> <strong>Anteckning</strong>: Den här strategin ger bästa prestanda men kräver mer minne för att lagra cachelagrade artefakter.</td>
  </tr>
 </tbody>
</table>
...
Mer information finns i [Form Bridge](/help/forms/using/form-bridge-apis.md) artikel.
