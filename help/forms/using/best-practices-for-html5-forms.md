...
* Behåll minsta möjliga antal Draw-textelement i ett formulär. Draw-element är användbara när det gäller att förbättra läsbarheten och utseendet, men har inga funktioner för informationslagring. Du bör sammanfoga flera Draw-textelement till ett enda Draw-textelement. Låt ingen sten vara omsluten så att formen blir smidigare.
