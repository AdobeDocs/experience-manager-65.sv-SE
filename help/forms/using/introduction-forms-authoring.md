...
* **Egenskapswebbläsaren**
   ...
   Markera en komponent, tryck sedan på ![fältnivå](assets/field-level.png) > **[!UICONTROL Adaptive Form Container]** och tryck sedan på ![cmpr](assets/cmppr.png).
...
* **Sidinformationstema-alternativ** ![ ](assets/theme-options.png): Gör att du kan visa sidegenskaper, publicera/avpublicera ett formulär, starta ett formulärarbetsflöde och öppna formuläret i klassiskt gränssnitt.

* **** ![Emulatorlinjal](assets/ruler.png): Gör att du kan emulera formulärutseendet för olika visningsstorlekar, till exempel för surfplattor och telefoner.
...
* **guideContainer**: Roten för ett adaptivt formulär, som är markerat som  **[!UICONTROL Start of adaptive form]** i gränssnittet för det adaptiva formuläret. I den här komponenten kan du ange:
