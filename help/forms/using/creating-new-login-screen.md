...
1. Gör följande:
   ...
   1. Replikera den hierarkiska strukturen: för `/libs/livecycle/core/content` på `/apps/livecycle/core/content`.
...
1. Utför följande åtgärder:
   ...
   1. Replikera den hierarkiska strukturen: för `/libs/livecycle/core/components/login` på `/apps/livecycle/core/components/login`. Behåll samma egenskaper (nod/mapp) och åtkomstkontroll.
