...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td><p>Hämta från Microsofts webbplats.</p> </td>
  </tr>
  <tr>
   <td>Oracle</td>
...
<table>
 <tbody>
  ...
  <tr>
   <td><p>Red Hat Enterprise Linux 7 (Kernel 3.x) (64-bitars)</td>
   <td><p>S: Stöds</p> </td>
...
* AEM Forms på JEE stöder olika tredjepartsprogram enligt vår [policy för tredjepartsprogramsupport](../../forms/using/aem-forms-jee-supported-platforms.md#p-third-party-patch-support-policy-p).
...
>Dessutom:
>
>* PDF Generator kräver 32-bitarsversionen av [Acrobat 2017 version 17.011.30078 eller senare](https://helpx.adobe.com/acrobat/release-note/release-notes-acrobat-reader.html) för att kunna utföra konverteringen.
