...
- **Service Pack-täckning**: Adobe ger teknisk support för AEM Forms-miljöer som kör alla Service Pack som släppts under de senaste 18 månaderna. Om din nuvarande version ligger utanför 18-månadersperioden rekommenderar Adobe starkt att du uppgraderar till det senaste Service Pack-versionen för att få optimala prestanda, säkerhet och kontinuerlig support.
...
>[!NOTE]
>
> Kontakta AEM Forms support om du har frågor om vilka format eller plattformsversioner som stöds.
...
### Utgåva 6.5.23.0 (juli 2025)

| Tillagd support | Borttaget stöd | Föråldrat stöd |
| -------------- | --------------- | ------------------- |
| Red Hat® Enterprise Linux® 9 (Kernel 4.x) (64-bitars) |  |  |
