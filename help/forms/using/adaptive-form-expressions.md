...
När värdet för **marital_status** fältändringar, hämtas uttrycket. Du kan också fylla i listrutan från en REST-tjänst. Mer information finns i [Dynamiskt ifyllbara listrutor](../../forms/using/dynamically-populate-dropdowns.md).
