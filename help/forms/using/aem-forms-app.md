...
Information om hur du installerar, anpassar och distribuerar programmet på iOS-, Android- eller Windows-enheter finns i [Anpassa, skapa och distribuera AEM Forms-appen](#customize-build-distribute).
...
**Varumärke**: Ändra programikonen, appnamnet, startbilder och sidor i AEM Forms-appen. Du kan också ändra text för att lokalisera programmet för ett visst område. Mer information om anpassning av varumärken för AEM Forms finns i Anpassning [av](/help/forms/using/branding-customization.md)varumärkesprofilering.
...
Källkoden för AEM Forms-appen kan extraheras från den `adobe-lc-mobileworkspace-src.zip` som är tillgänglig som en del av AEM Forms appkällpaket för programdistribution.
