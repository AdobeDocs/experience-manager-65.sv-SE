...
Mer information om arbetsflöden och funktioner för Forms-centrerade AEM finns i [Forms-centrerat arbetsflöde i OSGi](/help/forms/using/aem-forms-workflow.md).
