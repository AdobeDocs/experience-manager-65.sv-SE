...
Den här självstudiekursen är ett steg i [Skapa ditt första adaptiva formulär](../../forms/using/create-your-first-adaptive-form.md)-serien. Vi rekommenderar att du följer serien i kronologisk ordning för att förstå, utföra och demonstrera det fullständiga exemplet på självstudiekurser.
...
1. Installera JDBC-drivrutin för [!DNL MySQL]-databas som ett OSGi-paket:
   ...
   1. Tryck på **[!UICONTROL Choose File]** för att bläddra och välja OSGi-paketet för JDBC-drivrutinen. [!DNL MySQL] Välj **[!UICONTROL Start Bundle]** och **[!UICONTROL Refresh Packages]** och tryck på **[!UICONTROL Install or Update]**. Kontrollera att JDBC-drivrutinen [!DNL Oracle Corporation's] för [!DNL MySQL] är aktiv. Drivrutinen är installerad.
...
1. Konfigurera [!DNL MySQL]-databasen som en datakälla:
   ...
   1. Ange följande information i konfigurationsdialogrutan:
      ...
      * **JDBC-drivrutinsklass**: Ange Java-klassnamnet för JDBC-drivrutinen. För [!DNL MySQL]-databasen anger du **com.mysql.jdbc.Driver**.
      ...
      * **Testa på Lån:** Aktivera  **[!UICONTROL Test on Borrow]** alternativet.
      * **Test on Return:** Aktivera  **[!UICONTROL Test on Return]** alternativet.
      * **Valideringsfråga:** Ange en SELECT-fråga (SQL) för att validera anslutningar från poolen. Frågan måste returnera minst en rad. Välj till exempel *** från kundinformation**.
      * **Transaktionsisolering**: Ange värdet  **READ_COMMTED**.

         Lämna övriga egenskaper med standardvärdena [och ](https://tomcat.apache.org/tomcat-7.0-doc/jdbc-pool.html) och tryck på **[!UICONTROL Save]**.
...
AEM [!DNL Forms] har ett intuitivt användargränssnitt för att [skapa en formulärdatamodell](data-integration.md) från konfigurerade datakällor. Du kan använda flera datakällor i en formulärdatamodell. Vi kommer att använda den konfigurerade datakällan [!DNL MySQL].
...
1. I dialogrutan Skapa formulärdatamodell anger du ett **namn** för formulärdatamodellen. Exempel: **customer-shipping-billing-details**. Tryck på **[!UICONTROL Next]**.
1. På skärmen Välj datakälla visas alla konfigurerade datakällor. Välj **Datakällan WeRetailMySQL** och tryck på **[!UICONTROL Create]**.
...
1. Konfigurera läs- och skrivtjänster för datamodellobjektet.
   ...
   1. Välj på liknande sätt **[!UICONTROL update]** som skrivtjänst. Objektet **kundinformation** läggs automatiskt till som ett argument. Argumentet är konfigurerat enligt följande.
   ...
   1. Tryck på **[!UICONTROL Done]** för att spara datamodellens objektegenskaper. Tryck sedan på **[!UICONTROL Save]** för att spara formulärdatamodellen.

      Tjänsterna **[!UICONTROL get]** och **[!UICONTROL update]** läggs till som standardtjänster för datamodellobjektet.

      ![data-model-object](assets/data-model-object.png)

1. Gå till fliken **[!UICONTROL Services]** och konfigurera tjänsterna **[!UICONTROL get]** och **[!UICONTROL update]**.

   1. Välj tjänsten **[!UICONTROL get]** och tryck på **[!UICONTROL Edit Properties]**. Dialogrutan Egenskaper öppnas.
   ...
   1. Välj tjänsten **[!UICONTROL update]** och tryck på **[!UICONTROL Edit Properties]**. Dialogrutan Egenskaper öppnas.
   ...
   1. Ange följande i dialogrutan [!UICONTROL Edit Properties]:
      ...
      * **Argument**: Välj argument med namnet  **** ID och  **kundinformation**.
      Tryck på **[!UICONTROL Done]**. Tjänsten **[!UICONTROL update]** som uppdaterar kundinformation i [!DNL MySQL]-databasen har konfigurerats.
...
1. Gå till fliken **[!UICONTROL Model]**, markera datamodellsobjektet **kundinformation** och tryck på **[!UICONTROL Test Model Object]**.
...
1. I avsnittet **kundinformation** anger du ett värde för argumentet **id** som finns i den konfigurerade [!DNL MySQL]-databasen och trycker på **[!UICONTROL Test]**.
