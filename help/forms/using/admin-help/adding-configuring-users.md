...
1. (Valfritt) Om du vill tilldela roller till användaren klickar du på **[!UICONTROL Find Roles]** markerar du kryssrutan för de roller som ska tilldelas och klickar sedan på **[!UICONTROL OK]**.
...
1. Ange information för att begränsa sökningen efter en viss användare och klicka på **[!UICONTROL Find]**. Sökresultaten visas längst ned på sidan. Du kan sortera listan genom att klicka på någon av kolumnrubrikerna.
...
1. Om du vill redigera gruppinställningarna för användaren klickar du på **[!UICONTROL Group Membership]** och göra följande:
   ...
   * Klicka **[!UICONTROL Find Group]** och fylla i sökinformationen.
...
1. Om du vill redigera användarens roller klickar du på knappen **[!UICONTROL Role Assignments]** och göra följande:
