...
* Användarhantering kan inte skilja mellan två domännamn som bara skiljer sig åt när utökade tecken används. Om du t.ex. skapar en domän med namnet *abcde* och en domän med namnet *âbcdè*, anses de som samma.
