...
1. Gör något av följande:
   ...
   1. Om du vill lägga till teckensnittsfamiljen för elementet HTML kopierar du filen `/libs/ws/js/runtime/templates/appnavigation.html` till `/apps/ws/js/runtime/templates/appnavigation.html`.
