...
1. Klicka för att öppna fliken **Formulärmodell** och välj en av följande modeller för fragmentet i listrutan **Välj från**:
...
1. Klicka på **Skapa** och klicka sedan på **Öppna** för att öppna fragmentet, med en standardmall, i redigeringsläge.
...
1. Klicka på **Resurser** ![assets-browser](assets/assets-browser.png) i sidofältet. Välj **Adaptiva formulärfragment** i listrutan i resursläsaren.
...
Du kan välja att bädda in ett adaptivt formulärfragment i ett adaptivt formulär genom att klicka på **Bädda in resurs: &lt;*fragmentName*>**-knapp i panelverktygsfältet för det tillagda fragmentet, vilket visas i följande exempelbild.
...
1. Klicka på **Markera** i AEM Forms UI-verktygsfältet och välj ett adaptivt formulärfragment. Verktygsfältet innehåller följande åtgärder som du kan utföra på det valda adaptiva formulärfragmentet.
...
* (**Endast Mac**) Om du vill vara säker på att funktionen för formulärfragment fungerar perfekt i alla scenarier lägger du till följande post i filen /private/etc/hosts:
   `127.0.0.1 <Host machine>` **Värddator**: Apple Mac-datorn som AEM Forms körs på.
