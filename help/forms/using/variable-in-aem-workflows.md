...
seo-title: Variabler i AEM Forms-arbetsflöden
description: Skapa en variabel, ange ett värde för variabeln och använd den i AEM Forms arbetsflödessteg.
seo-description: Skapa en variabel, ange ett värde för variabeln och använd den i AEM Forms arbetsflödessteg.
...
* [Skapa en ](../../forms/using/variable-in-aem-workflows.md#create-a-variable) variabel av en datatyp baserat på den informationstyp som du vill lagra i den.
* [Ange ett värde för ](../../forms/using/variable-in-aem-workflows.md#set-a-variable) variabeln med hjälp av arbetsflödessteget Ange variabel.
* [Använd ](../../forms/using/variable-in-aem-workflows.md#use-a-variable) variabeln i alla AEM Forms arbetsflödessteg för att hämta det lagrade värdet och i stegen ELLER Dela och Gå till för att definiera ett routningsuttryck.
...
1. I en AEM går du till Verktyg ![](/help/forms/using/assets/hammer.png) > Arbetsflöde > Modeller.
...
1. Ange en valfri beskrivning för variabeln och tryck på ![ready_icon](assets/done_icon.png) för att spara ändringarna. Variabeln visas i listan som är tillgänglig i den vänstra rutan.
...
1. Mappa fler variabler för att skapa ett meningsfullt uttryck. Tryck på ![ready_icon](assets/done_icon.png) för att spara ändringarna.
...
Mer information finns i [redigerare för regel för adaptiva formulär](../../forms/using/rule-editor.md).
...
I det här exemplet använder du [example 2](../../forms/using/variable-in-aem-workflows.md#example2) för att ange värdet för variabeln **total value** innan du definierar routningsuttrycket. Grupp 1 är aktiv om värdet för variabeln **totalvärde** är större än 50000. På samma sätt kan du definiera en regel som gör grenen 2 aktiv om värdet för variabeln **totalvalue** är mindre än 50000.
...
Alla AEM Forms arbetsflödessteg har stöd för variabler. Mer information finns i [Forms-centrerat arbetsflöde på OSGi](../../forms/using/aem-forms-workflow-step-reference.md).
...
1. Tryck på ikonen ![edit](assets/edit.png) (Edit) bredvid variabelnamnet som du vill redigera.
1. Redigera variabelinformationen och tryck på ![ready_icon](assets/done_icon.png) för att spara ändringarna. Du kan inte redigera fälten **[!UICONTROL Name]** och **[!UICONTROL Type]** för en variabel.
...
1. Tryck på ![ready_icon](assets/done_icon.png) för att bekräfta och ta bort variabeln.

## Referenser {#references}

Mer exempel på hur du använder variabler i AEM Forms arbetsflödessteg finns i [Variabler i AEM arbetsflöden](https://helpx.adobe.com/experience-manager/kt/forms/using/authoring_variables_in_aem_forms-workflow1.html).
