...
1. Klicka på **Adobe Experience Manager** > **Verktyg** ![hammikon](/help/forms/using/assets/tools.png) > **Cloud Service** > **Äldre Cloud Service** i det övre vänstra hörnet.
...
1. Om du vill mappa Analytics-variabler med variabler som är definierade i komponenten drar du en variabel från AEM Content Finder till ett fält i spårningskomponenten.
   ...
   ![Mappa AEM med Adobe Analytics-variabler](assets/analytics_new.png)
...
1. Öppna konfigurationshanteraren AEM Web Console på `https://<server>:<port>;/system/console/configMgr` om du har en författarinstans.
...
1. Ange lämpliga värden för följande fält och klicka på **Spara**.
   ...
   * **SiteCatalyst Framework**: Markera ramverket/konfigurationen som du definierade i avsnittet Konfigurera ett ramverk för spårning.
