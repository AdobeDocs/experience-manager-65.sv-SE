...
1. Välj **Ny**. En lista över fält som krävs för att skapa den bevakade mappen visas:
   ...
   * **Sökväg**: Anger den bevakade mappens plats. I en klustrad miljö måste den här inställningen peka på en delad nätverksmapp som är tillgänglig för alla användare som kör AEM på olika noder i ett kluster.
