...
+ Uppgradera AEM Forms {#upgrade-aem-forms}
   ...
   + Uppgradera AEM Forms på JEE {#aem-forms-jee-upgrade}
      ...
      + [Uppgradera från en AEM Forms-version till AEM 6.5 Forms on JEE for JBoss körklar](http://www.adobe.com/go/learn_aemforms_upgradeTurnkey_65)
...
+ Adaptiva formulär - avancerad redigering {#adaptive-forms-advanced-authoring}
   ...
   + [Bädda in ett adaptivt formulär eller interaktiv kommunikation i AEM Sites Single Page Application](/help/forms/using/embed-adaptive-form-aem-sites-spa.md)
...
+ Arbetsflöden {#workflows}
   ...
   + [Inloggning i arbetsflöden för AEM Forms](/help/forms/using/forms-workflow-logs.md)
