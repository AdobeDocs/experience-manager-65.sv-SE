...
[Snabbstart (SOAP-läge): Hämta namn på signaturfält med Java API](signature-service-java-api-quick.md#quick-start-soap-mode-retrieving-signature-field-names-using-the-java-api)
