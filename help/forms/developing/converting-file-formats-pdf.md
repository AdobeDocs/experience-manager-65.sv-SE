...
När det här avsnittet och nästa avsnitt beskriver dialogrutor och deras komponenter ur användarens perspektiv, används termer som *dialog*, *button*, *field* och *kombinationsruta*.
...
Namnet på XML-filen för den ytterligare dialogrutan måste ha formatet `appmon.[applicationname].addition.[locale].xml`, där *programnamn* måste matcha programnamnet som används i XML-konfigurationsfilen och i skriptet exakt.
