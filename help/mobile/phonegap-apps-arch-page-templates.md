...
Så som beskrivs i [AEM sidmallar](/help/mobile/apps-architecture.md) kan varje komponent generera ett JavaScript-fragment för att förbruka det JSON-innehåll som exponeras av `data` -löftet. I enlighet med Angularnas konventioner bör en kontrollenhet endast användas för att tilldela variabler till omfånget.
...
Produktkomponenten för programmet We.Retail är ett mer komplext exempel (/apps/werdetaljail-app/components/angular/ng-product):
...
Den här katalogen innehåller [CLI-krokarna](https://gist.github.com/jlcarvalho/22402d013bc72f795d45a01836ce735c). Mapparna i hooks-katalogen innehåller node.js-skript som körs vid exakta punkter under bygget.
