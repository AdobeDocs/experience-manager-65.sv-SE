...
Den här versionen av AEM har stöd för mobila enheter från iOS och Android™.
...
1. Under Android™-paketnamn anger du ditt program-ID, det vill säga `com.adobe.cq.mobile.weretail.outdoorsapp`. (Om det inte fungerar kan du försöka igen med &quot;test.test&quot;.)
...
>[!NOTE]
>
>*Information om Amazon SNS, och en länk för att skapa ett AWS-konto, finns [här](https://aws.amazon.com/sns/). Du kan få ett kostnadsfritt konto i ett år.*
...
1. **Skapa plattformsprogram**
   ...
   1. Upprepa ovanstående steg en gång för varje plattform som du stöder. För att kunna köra både iOS och Android™ måste två plattformsprogram skapas.
...
1. Hantera resultaten
   ...
   * Observera att det finns vissa plattformsskillnader mellan push-meddelanden för iOS och Android™. Bland dem:
      ...
      * I Android™ är texten på OK i versaler (och i alla andra knappar som läggs till i meddelandet i appen), men inte i iOS.
