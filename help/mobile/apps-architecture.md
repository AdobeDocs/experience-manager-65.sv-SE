...
Filen package.json är en manifestfil som listar de filer som ingår i en **full** Content Sync-hämtning. Den här filen innehåller också den tidsstämpel som nyttolasten för innehållssynkronisering genererades vid (`lastModified`). Den här egenskapen används vid begäran om partiella uppdateringar av appen från AEM.
