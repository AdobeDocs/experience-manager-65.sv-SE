...
1. I **Indexerade typer** -flik, ange **Sammansatt typ** till:
...
>[!NOTE]
>
>Du kan [anpassa processen genom att implementera en egen importhanterare](#configure-the-import-structure).
