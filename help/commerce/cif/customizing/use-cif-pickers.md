...
I produktfältet kan användaren navigera till den produkt som användaren vill välja genom de olika vyerna. Som standard returnerar produktfältet produktens ID, men det kan konfigureras med `selectionId` -attribut.
...
>[!CAUTION]
>
>Från och med CIF Core Components version 2.0.0 finns stöd för `id` togs bort och ersattes med `uid`. Adobe rekommenderar att du använder `sku` eller `slug` som produkt-ID. Adobe fortsätter att stödja `id` endast för projekt som använder CIF Core Components version 1.x.
...
>[!CAUTION]
>
>Från och med CIF Core Components version 2.0.0 finns stöd för `id` togs bort och ersattes med `uid`. Adobe rekommenderar att du använder `uid` eller `urlPath` som kategoriidentifierare. Adobe fortsätter att stödja `id` &amp; `idAndUrlPath` endast för projekt som använder CIF Core Components version 1.x.
