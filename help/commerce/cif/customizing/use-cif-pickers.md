...
>[!CAUTION]
>
>Från och med CIF Core Components version 2.0.0 stöds `id` togs bort och ersattes med `uid`. Adobe rekommenderar att du använder `sku` eller `slug` som produkt-ID. Adobe fortsätter att stödja `id` endast för projekt som använder CIF Core Components version 1.x.
