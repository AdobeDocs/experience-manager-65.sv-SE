...
1. Använd **Navigering**, gå via **Distribution**, **Cloud Service** till avsnittet **Adobe Analytics**.
...
Du kan konfigurera AEM att skicka händelser och variabeldata till Adobe Analytics när en användare klickar på en länk. Med egenskaperna **Konfiguration för länkspårning** kan du ange vilka Adobe Analytics-händelser och -variabler som ska spåras när länkklick inträffar.
