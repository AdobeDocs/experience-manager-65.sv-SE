...
Exemplet med webbutiker innehåller exempel på Facebook- och Twitter-appar samt molntjänster, men de är inte tillgängliga på en [produktionswebbplats](../../help/sites-administering/production-ready.md).
...
1. **Skapa** en social app och molntjänst.
   ...
   * Så här hanterar du inloggning med Facebook:
      ...
      * Skapa och publicera [Molntjänsten facebook Connect](#create-a-facebook-connect-cloud-service).

   * Så här stöder du inloggning med Twitter:

      * Skapa en [Twitter](#create-a-twitter-app).
      * Skapa och publicera [Molntjänsten twitter Connect](#create-a-twitter-connect-cloud-service).
...
1. **Skapa/redigera** Facebook molntjänstkonfiguration.
   ...
   * **[!UICONTROL Title]** (*Obligatoriskt*) Ange en visningsrubrik som identifierar Facebook App. Använd samma namn som anges för *Visningsnamn* för Facebook.
...
1. När programmet har skapats letar du reda på **[!UICONTROL Consumer (API) Key]** och **[!UICONTROL Consumer (API) Secret]**. Den här informationen behövs för att konfigurera [molntjänst för twitter](#createatwittercloudservice).
...
* **[!UICONTROL Additional Permissions]**: Välj valfritt `Request email addresses from users`.
...
The [Adobe Granite OAuth-program och -leverantör](#adobe-granite-oauth-application-and-provider) -instansen, som initieras genom att en molntjänstkonfiguration skapas, identifierar det Twitter och den eller de medlemsgrupper som de nya användarna läggs till i.
...
1. Skapa/redigera molntjänstkonfiguration för Twitter.
   ...
   * **[!UICONTROL Consumer Key]**
     ...
     (*Obligatoriskt*) Ange **Kundnyckel (API)** för Twitterna. Detta identifierar [Adobe Granite OAuth-program och -leverantör](https://helpx.adobe.com/experience-manager/6-3/communities/using/social-login.html#AdobeGraniteOAuthApplicationandProvider) -instans som har skapats från dialogrutan.
...
Resultatet är ett [Adobe Granite OAuth-program och -leverantör](https://helpx.adobe.com/experience-manager/6-3/communities/using/social-login.html#adobe-granite-oauth-application-and-provider) -instans som inte behöver ändras ytterligare. Standardomfånget är standardbehörigheten för Twitternas inloggning.
