...
* Följ [Prestandaoptimering](/help/sites-deploying/configuring-performance.md) och [Tips för prestandajustering](https://experienceleague.adobe.com/docs/experience-manager-65/deploying/configuring/configuring-performance.html) dokumentation.
