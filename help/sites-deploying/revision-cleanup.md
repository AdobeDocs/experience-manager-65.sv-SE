...
**Anteckning**: [Se videon](https://experienceleague.adobe.com/docs/experience-manager-learn/foundation/administration/use-online-revision-clean-up.html?lang=en) om du vill ha en introduktion och hur du använder funktionen för rensning av onlineversioner.
...
Du kan även läsa [officiell dokumentation](https://jackrabbit.apache.org/oak/docs/nodestore/segment/overview.html).
   ...
   <td>Du kan söka efter och åtgärda problemet i flera steg:<br />
    <ul>
     ...
     <li>Beroende på informationen i loggarna ska du vidta lämpliga åtgärder:
      <ul>
       <li>Om loggarna visar fem missade kompakta cykler och en timeout på <code>forceCompact</code> schemalägg underhållsfönstret till en lugn tid när mängden databasskrivningar är låg. Du kan kontrollera databasskrivningar i verktyget för övervakning av databasmått på <em>https://serveraddress:serverport/libs/granite/operations/content/monitoring/page.html</em></li>
  ...
  <tr>
   ...
   <td><p>A <code>SegmentNotFoundException</code> loggas av tarMK när den försöker komma åt en lagringsenhet (ett segment) som den inte kan hitta. Det finns tre scenarier som kan orsaka problemet:</p>
    <ol>
     ...
     <li>Åtgärda alla andra förekomster via <a href="https://experienceleague.adobe.com/?support-solution=General&amp;support-tab=home#support" target="_blank">Adobe kundtjänst</a>.</li>
    </ol> </td>
   <td> </td>
  </tr>
 </tbody>
