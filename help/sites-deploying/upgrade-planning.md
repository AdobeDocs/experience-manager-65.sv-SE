...
<table>
 <tbody>
  ...
  <tr>
   <td>AEM/innehåll</td>
   <td>Måttlig effekt</td>
   <td><code>/libs</code> och <code>/apps</code> hanteras enkelt genom uppgraderingen, men <code>/etc</code> kräver vanligtvis manuell omtillämpning av anpassningar.</td>
  </tr>
  <tr>
   <td>AEM</td>
   <td>Låg effekt</td>
  ...
  <tr>
   ...
   <td>Beroende på program och anpassning kan det finnas <br />-beroenden för JVM, operativsystemversioner och vissa indexeringsrelaterade<br />-ändringar, eftersom index inte genereras automatiskt i Oak.</td>
  </tr>
  <tr>
...
Det är viktigt att du kör ett operativsystem som stöds, Java-miljön, httpd- och Dispatcher-versionen. Mer information finns på sidan [AEM 6.5 Tekniska krav](/help/sites-deploying/technical-requirements.md). Du måste ta hänsyn till att du uppgraderar dessa komponenter i din projektplan och de bör göras innan du uppgraderar AEM.
...
### Fastställande av nödvändiga ändringar i arkitektur och infrastruktur {#determining-architectural-and-infrastructure-changes-needed}
...
### Utför utveckling och QA {#performing-development-and-qa}

Vi har skapat procedurer för [Uppgradering av kod och anpassningar](/help/sites-deploying/upgrading-code-and-customizations.md) för att vara kompatibla med AEM 6.5. När den här iterativa processen körs bör ändringar göras i Runbook efter behov. Se även [Bakåtkompatibilitet i AEM 6.5](/help/sites-deploying/backward-compatibility.md) om hur anpassningarna i de flesta fall kan vara bakåtkompatibla utan att behöva utvecklas omedelbart efter uppgraderingen.
