...
I den här delen av [AEM Headless Content Architect Journey](overview.md) kan du lära dig de (grundläggande) begrepp och termer som krävs för att förstå innehållsmodellering för headless Content Delivery med Adobe Experience Manager (AEM).
