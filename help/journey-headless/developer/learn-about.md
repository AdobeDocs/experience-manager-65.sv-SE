...
Bygg vidare på denna kunskap och fortsätt din AEM resa utan trassel genom att nästa gång granska dokumentet [Komma igång med AEM Headless](getting-started.md) där du får lära dig hur du konfigurerar de nödvändiga verktygen och hur du börjar fundera på hur AEM inriktar sig på headless-innehållsleverans och dess förutsättningar.
