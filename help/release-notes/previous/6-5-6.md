...
* Stöd för [Adobe Sign-texttaggar i den automatiska formulärkonverteringstjänsten](https://experienceleague.adobe.com/docs/aem-forms-automated-conversion-service/using/convert-existing-forms-to-adaptive-forms.html?lang=sv-SE).
...
Mer information om säkerhetsuppdateringar finns på [Experience Manager säkerhetsbulletiner](https://helpx.adobe.com/se/security/products/experience-manager.html).
