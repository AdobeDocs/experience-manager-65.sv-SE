...
* **GraphQL API för[!DNL Content Fragments]**: Bindestreck tillåts inte längre i egenskapsfältet för innehållsfragmentmodellen för att stödja GraphQL API. GraphQL-frågor kan returnera oönskade resultat om det finns ett bindestreck i något av egenskapsnamnen för Content Fragment Model.
