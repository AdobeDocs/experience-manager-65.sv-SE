...
* Om du väljer **[!UICONTROL Documents]** och sedan väljer **[!UICONTROL Filtertype]** eller **[!UICONTROL Microsoft®® Word]** under **[!UICONTROL Microsoft®® Excel]** i Assets visas inga resultat trots att det finns filer av båda typerna. (SITES-14837)
