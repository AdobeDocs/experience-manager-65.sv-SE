...
* Om du lägger till [!DNL Dynamic Media]-Scene7-komponenten på sidan och sedan publicerar sidan, utlöses inte Dmscene7-konfigurationen varje gång. NPR-30641: Programfix för CQ-4275962
...
* Om du konfigurerar [!DNL Dynamic Media] molntjänster i [!DNL Dynamic Media]-hybridläge skapas flera tomma rapportsviter som skapats i [!DNL Analytics], och inget rapportsuite-ID sparas i [!DNL Experience Manager], vilket resulterar i dubbletter av rapportsviten. Programfix för CQ-4249780
* Det går inte att synkronisera om namnbytet i resursen [!DNL Experience Manager] till duplicerat namn till Scene7. Programfix för CQ-4276763
* Användargenererat innehåll visas felaktigt på sökfilterpanelen. Programfix för CQ-4273875
* Alternativet Sök liknande är inte tillgängligt för TIFF-bilder. Programfix för CQ-4278238
...
* Uppgraderad instans från 6.3.3.2 till 6.5 resulterar i duplicerade OSGi-konfigurationer. NPR-30130: Programfix för CQ-4274016
...
* När du använder NonVisual Desktop Access i bläddringsläge för att läsa ett HTML5-formulär, läser webbläsaren i Chrome &quot;graphic&quot; före varje skalbar vektorgrafik (SVG) i formulärdesignen. NPR-30449: Programfix för CQ-4274732
