...
* Ta bort kod och beroenden för Adobe Search &amp; Promote från AEM 6.5, som uppnådde slutet på livscykeln [september 2022 enligt meddelande](https://experienceleague.adobe.com/sv/docs/discontinued/using/search-promote). (NPR-41855)
...
* SITES-17934 - Content Fragments - Preview misslyckas på grund av DoS-skydd för stora fragmentträd. Läs artikeln [KB om standardkonfigurationsalternativ för GraphQL Query Executor](https://experienceleague.adobe.com/sv/docs/experience-cloud-kcs/kbarticles/ka-23945)
