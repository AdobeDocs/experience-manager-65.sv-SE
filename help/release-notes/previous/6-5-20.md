...
* När du använder Snabbformatera Publish för ett innehållsfragment fortsätter inläsningen och publiceras inte. Det innebär att Quick Publish inte fungerar för innehållsfragment efter en uppgradering från AEM 6.5.7 till AEM 6.5.17. När användaren testade hanterad publicering fungerade det. Men när de försökte med Quick Publish publicerades den inte. I synnerhet `com.day.cq.wcm.core.impl.reference.ActivationReferenceSearchBuilder` orsakade att systemet kraschade. (SITES-17311)
