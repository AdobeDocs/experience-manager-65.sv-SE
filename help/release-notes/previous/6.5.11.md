...
* När du installerar AEM 6.5 Service Pack 11 kan du få problem med sökfunktionen Resurser (bilder). I så fall rekommenderar vi att du uppgraderar till 6.5.12.0 och installerar rätt programfix.
