...
* Nu kan du använda [OAuth2 för autentisering med Microsoft® Office 365 e-postserverprotokoll (SMTP och IMAP)](/help/forms/using/oauth2-support-for-mail-service.md). (NPR-35177)
...
* [Förteckning över OSGi-paket i Experience Manager 6.5.15.0](/help/release-notes/assets/65150_bundles.txt) <!-- UPDATE FOR EACH NEW RELEASE -->
* [Förteckning över innehållspaket i Experience Manager 6.5.15.0](/help/release-notes/assets/65150_packages.txt) <!-- UPDATE FOR EACH NEW RELEASE -->
