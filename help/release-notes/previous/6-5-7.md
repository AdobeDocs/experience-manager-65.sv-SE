...
De viktigaste funktionerna och förbättringarna i [!DNL Adobe Experience Manager] 6.5.7.0 omfattar:
...
[!DNL Adobe Experience Manager] 6.5.7.0 [!DNL Assets] åtgärdar följande problem och erbjuder följande förbättringar.
...
* Användare utan administratörsbehörighet kan redigera utgångna resurser med hjälp av [Experience Manager]-datorprogrammet. (NPR-34993)
...
* [!DNL Dynamic Media]-video spelas inte upp på iOS-enheter med HTML 5-videokontrollerna (CQ-4306977, CQ-4306727).
...
* I [!UICONTROL Viewer Presets Editor] är modifieringsetiketten [!UICONTROL PanoramicImage/PanoramicImage_VR] inte tillgänglig när du redigerar förinställningen `PanoramicView` i komponenten `PANORAMICVIEW_AUTOROTATE` (CQ-4302443).
...
* AEM visar följande felmeddelande när du schemalägger ett dagligt underhållsfönster mellan 2 dagar (NPR-35280):
...
* När du konverterar en PDF-fil till ett adaptivt formulär kan du inte ange ett värde för en kapslad panel med hjälp av en formulärdatamodell i fliklayouten. Det finns dessutom problem när du ställer in ett värde för alternativknappsgrupper dynamiskt med en statisk array med kodredigeraren (NPR-35062).
...
UberJar för Experience Manager 6.5.7.0 är tillgänglig i [Maven Central-databasen](https://repo.maven.apache.org/maven2/com/adobe/aem/uber-jar/6.5.7/).
