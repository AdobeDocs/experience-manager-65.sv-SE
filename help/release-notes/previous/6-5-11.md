...
* AEM Forms på JEE har nu stöd för Apache Geode som cachningslösning.
...
1. OSGi-paketet `org.apache.jackrabbit.oak-core` är version 1.2.2.9 eller senare (Använd webbkonsol: `/system/console/bundles`).
