...
* **Sidpublicering fungerar inte i Page Editor efter uppgradering till Service Pack 18 (6.5.18.0)**
  ...
  När du har uppgraderat en instans av AEM 6.5.0.0-6.5.17.0 till AEM 6.5.18.0 klickar du **Publicera sida** i sidredigeraren omdirigeras du till en URL som inte finns.
