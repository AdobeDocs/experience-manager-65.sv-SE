...
UberJar för [!DNL Experience Manager] 6.5.23.0 är tillgänglig i [Maven Central-databasen](https://repo.maven.apache.org/maven2/com/adobe/aem/uber-jar/6.5.23/). <!-- CHECK FOR UPDATE EACH NEW RELEASE -->
...
* **FORMS-15681**:When - brevet visas i Förhandsgranska utskrift, innehållet ändras. Vissa blanksteg försvinner och vissa bokstäver ersätts med `x`.
