...
* Förkorta tiden för uppdatering av en sida efter att du har dragit [!DNL Experience Fragments] till [!DNL Sites] Sidredigeraren.
...
Auktoriseringskanalen mellan [!DNL Experience Manager Assets] och [!DNL Brand Portal] ändras. Tidigare [!DNL Brand Portal] konfigurerades i Classic UI via äldre OAuth Gateway, som använder JWT-tokenutbyte för att erhålla en IMS Access-token för auktorisering. [!DNL Experience Manager Assets] är nu konfigurerat med [!DNL Brand Portal] via [!DNL Adobe I/O], som köper en IMS-token för att godkänna din [!DNL Brand Portal] tenant.
