...
* Publicera [!DNL Experience Manager Assets] från mappen [!DNL Experience Manager] Författare /content/dam/mac till [!DNL Brand Portal] fungerar inte. NPR-29819: Programfix för CQ-427118
...
* När en fullständig tillgänglighetskontroll utförs på den statiska PDF som skapats med [!DNL Experience Manager Forms Designer] misslyckas kontrollen för primärt språk på grund av att språkattribut saknas. Programfix för CQ-4272923, CQ-4271002
...
* Verifiering av signaturer i en PDF med PDF Advanced Electronic Signatures (PAdES) genererar InvalidOperationException. NPR-29842: Programfix för CQ-4244837
...
* Den statiska PDF som skapas av [!DNL Experience Manager Forms]-serverns utdatamoddul fyller inte i språkattributet/taggen med språket för det dokument som skapas. NPR-27332: Programfix för CQ-4271002
...
UberJar för Experience Manager 6.5.1.0 är tillgänglig i [Maven Central-databasen](https://repo.maven.apache.org/maven2/com/adobe/aem/uber-jar/6.5.1/).
