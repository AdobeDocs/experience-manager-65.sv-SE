...
* En webbsida med tecknet `/` i URL:en slutar svara vid redigering. När en komponent läggs till under utvecklingen ökar processoranvändningen och webbläsaren slutar svara (CQ-4295749).
...
* Om en administratör konfigurerar [!DNL Experience Manager Assets] 6.5.4 med varumärkesportalen via Adobe Developer Console kan inte [!DNL Brand Portal]-användaren publicera en resurs i en mapp från [!DNL Brand Portal] till [!DNL Experience Manager] (NPR-33046).
...
### Foundation-gränssnitt {#foundation-ui-6540}
...
### WCM-sidredigeraren {#wcm-page-editor-6540}
...
### Kampanjmål {#campaign-targeting-6540}
...
### {#feature-packs-included-6530} innehåller funktionspaket
...
#### Platser {#sites-feature-packs-included}
