...
* Resurser som användare kan söka efter visuellt liknande bilder. AEM visar de smarta taggade bilder från DAM-databasen som liknar den bild som användaren har valt. Se [visuell sökning](../assets/search-assets.md#visualsearch).
