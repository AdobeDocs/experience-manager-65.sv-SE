...
| Utvecklare | `Hobbes.js`. Adobe planerar inte att göra ytterligare förbättringar av testningsramverket för användargränssnittet i `hobbes.js`. | Adobe rekommenderar att man använder Selenium automation. |
