...
Du kan redigera följande inställningar för dynamiska media genom att klicka **[!UICONTROL Edit]** i komponenten och sedan på **[!UICONTROL Dynamic Media Settings]** fliken.
