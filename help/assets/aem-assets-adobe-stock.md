...
* **Problem i integrationen med [!DNL Experience Manager] Service Pack 6.5.7.0 och senare**: Ett oväntat fel upptäcktes under integreringen med [!DNL Experience Manager] 6.5.7.0 och senare. Problemet testas och förväntas vara tillgängligt i [!DNL Experience Manager] 6.5.11.0. Kontakta [!DNL Customer Support] för att få en snabbkorrigering.
