...
Integreringen kräver en [enterprise [!DNL Adobe Stock] plan](https://stockenterprise.adobe.com/).
...
1. Klicka på **[!UICONTROL Create new project]** och klicka på **[!UICONTROL Add API]**. Välj **[!UICONTROL Adobe Stock]** i listan över API:er som är tillgängliga för dig. Välj [!UICONTROL OAUTH 2.0 Web]. Konfigurera och kopiera de olika värdena som presenteras.
...
>[!NOTE]
>
>Om det finns flera [!DNL Adobe Stock]-konfigurationer väljer du önskad konfiguration på panelen [!UICONTROL User Preferences]. Om du vill öppna panelen från startsidan för [!DNL Experience Manager] klickar du på användarikonen och sedan på **[!UICONTROL User Preferences]** > **[!UICONTROL Stock Configuration]**.
