...
1. I Experience Manager som Cloud Service väljer du **[!UICONTROL Tools]** > **[!UICONTROL Assets]** > **[!UICONTROL CDN Invalidation]**.
...
1. På sidan **[!UICONTROL CDN Invalidation - Confirm]** i listrutan **[!UICONTROL URLs]** kan du se en lista över en eller flera URL:er som genererats från CDN-valideringsmallen som du skapade tidigare och de resurser som du just lade till.
   ...
   Anta att du har lagt till en enskild resurs med namnet `spinset` med exemplet med mallen för CDN-invalidering som visades i stegen ovan. När du navigerar till **[!UICONTROL Tools]** > **[!UICONTROL Assets]** > **[!UICONTROL CDN Invalidation]** resulterar det i följande fem genererade URL:er i **[!UICONTROL CDN Invalidation - Confirm]**-användargränssnittet:
...
| *Inga URL:er har angetts som ogiltiga.* | Inträffar om det inte finns några URL-adresser på **[!UICONTROL CDN Invalidation - Confirm]**-sidan och du väljer **[!UICONTROL Submit]**. |
