...
Tänk dig ett scenario där du vill skapa digital tryckbar information som broschyrer, flygblad och annonser för en kommande kampanj och dela med butiker globalt. Genom att skapa material som bygger på en mall kan ni leverera en enhetlig kundupplevelse över alla kanaler. Designers kan skapa kampanjmallar (en eller flera sidor) med hjälp av en kreativ lösning, som [!DNL InDesign] och ladda upp mallarna till [!DNL Experience Manager Assets] för dig. Innan du skapar en säkerhet måste du ha en eller flera INDD-mallar överförda till och tillgängliga i [!DNL Experience Manager] i förväg.

1. I [!DNL Experience Manager] klicka [!UICONTROL Assets].

1. Välj bland alternativen **[!UICONTROL Templates]**.

   ![chlimage_1-101](assets/chlimage_1-306.png)

1. Klicka **[!UICONTROL Create]** och sedan väljer du det material du vill skapa på menyn. Välj till exempel **[!UICONTROL Brochure]**.
...
Du kan redigera en sammanställning direkt när du har skapat den. Du kan även öppna den från [!UICONTROL Templates] sidan eller resurssidan.
...
1. Gör något av följande om du vill öppna materialet för redigering:
   ...
   * Navigera från sidan Mallar till en mapp där du skapade materialet och klicka på [!UICONTROL Edit] Snabba åtgärder på miniatyrbilden av en säkerhet.
   ...
   * Markera säkerheten och klicka på **[!UICONTROL Edit]** i verktygsfältet.
   ...
   Med hjälp av resurssökaren kan du söka efter bilder i [!DNL Experience Manager Assets] och ersätta de redigerbara bilderna i mallen med de bilder du väljer.

   ![chlimage_1-109](assets/chlimage_1-314.png)

   De redigerbara visas till höger. För ett fält som ska kunna redigeras i [!DNL Experience Manager Assets]måste motsvarande fält i mallen taggas i [!DNL InDesign]. Med andra ord bör de markeras som redigerbara i [!DNL InDesign].
...
1. Klicka **[!UICONTROL Preview]** om du vill förhandsgranska textändringarna.

1. Klicka på **[!UICONTROL Asset Finder]** ![chlimage_1-113](assets/chlimage_1-318.png).
...
1. Klicka **[!UICONTROL Preview]** för att förhandsvisa bilden.
1. Om du vill redigera en viss sida i en flersidig säkerhetssida använder du sidnavigeraren längst ned.

1. Klicka **[!UICONTROL Preview]** i verktygsfältet för att förhandsgranska alla ändringar. Klicka **[!UICONTROL Done]** för att spara redigeringsändringarna i materialet.
...
1. I [!DNL Experience Manager] klicka [!UICONTROL Assets] på navigeringssidan.

1. Välj bland alternativen **[!UICONTROL Templates]**.

1. Klicka **[!UICONTROL Create]** och väljer **[!UICONTROL Merge]** på menyn.

   ![chlimage_1-120](assets/chlimage_1-325.png)

1. Från [!UICONTROL Template Merge] sida, klicka **[!UICONTROL Merge]** ![lägga till resurser](assets/do-not-localize/assets_add_icon.png).
...
1. Klicka **[!UICONTROL Save]** och sedan klicka **[!UICONTROL OK]** i dialogrutan för att stänga dialogrutan. Den flersidiga informationen skapas i den mapp du började med.
