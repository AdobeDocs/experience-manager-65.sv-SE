...
1. På sidan Image Server Publish (Image Server Publish) går du till **[!UICONTROL Publish Context]** nedrullningsbar meny nära överkanten, välj **[!UICONTROL Image Serving]**.
