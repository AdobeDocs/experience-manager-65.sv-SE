...
>[!NOTE]
Mekanismen liknar [att tillåta sidmallar](/help/sites-authoring/templates.md#allowing-a-template-author) för en sida och dess underordnade sidor i en sidas avancerade egenskaper.
