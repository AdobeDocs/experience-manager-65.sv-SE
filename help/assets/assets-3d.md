...
* Enklickspublicering (med **[!UICONTROL Quick Publish]** i verktygsfältet) för 3D-resurser för att generera en URL.
...
![Visa i 3d](/help/assets/assets-dm/3d-dimensional-viewer-quickpublish-url-embed2.png)
...
Se även [Stöd för 3D-format](/help/assets/assets-formats.md).
...
>
>Se [Hantera förinställningar för visningsprogram](/help/assets/managing-viewer-presets.md).

## Visa och interagera med en 3D-resurs från sidan med resursinformation {#viewing-three-d-assets-from-asset-details-page}

Se även [Förhandsgranska resurser med hjälp av programgränssnittet](/help/assets/previewing-assets.md).
...
>[!IMPORTANT]
>
>Du kan bara utföra den här åtgärden när du har lagt till en 3D-mediekomponent på en webbsida och tilldelat en 3D-resurs till komponenten. Se [Lägga till komponenten 3D Media på en webbsida](#adding-the-three-d-media-component-to-a-web-page) och [Tilldela en 3D-resurs till en 3D-mediekomponent](#assigning-a-three-d-asset-to-the-component).

Se även [Förhandsgranska resurser med hjälp av programgränssnittet](/help/assets/previewing-assets.md).

**Så här visar och interagerar du med en 3D-resurs i en 3D-mediekomponent:**

1. När en webbsida är i **[!UICONTROL Edit]** gör du något av följande:
...
1. I den nedrullningsbara menyn i sidans övre högra hörn väljer du **[!UICONTROL Structure]** om det inte redan är aktivt.
...
1. Välj **[!UICONTROL Edit]** (penna) så att du kan öppna sidan i sidredigeraren. Se till att **[!UICONTROL Edit]** Läget är markerat i sidans övre högra hörn.
...
1. I Experience Manager Sites sidredigerare väljer du **[!UICONTROL 3D Media Viewer]** som du tidigare har lagt till på sidan.
1. Välj **[!UICONTROL Configuration]** ikon (skiftnyckel) så att du kan öppna dialogrutan för komponentkonfiguration.

   ![3d-media-component-config](/help/assets/assets-dm/3d-media-component-config.png)

1. Välj i listrutan Visningsförinställning i dialogrutan 3D-media **[!UICONTROL Dimensional]** om du vill tilldela visningsförinställningen Dimensional till komponenten.
...
1. Dra 3D-resursen från resurspanelen och släpp den på **[!UICONTROL 3D Media]** som du tidigare har lagt till på sidan.
   ...
   ![Tilldela 3D-resurs till komponenten 3D Media](/help/assets/assets-dm/3d-asset-add.png)
...
Se även [Publicera Dynamic Media-resurser](publishing-dynamicmedia-assets.md).
...
1. Välj **[!UICONTROL Close]** för att stänga dialogrutan och återgå till sidan med resursinformation.
1. I listrutan till vänster om 3D-resursens filnamn väljer du **[!UICONTROL Renditions]**.

   ![3d-asset-renditions](/help/assets/assets-dm/3d-asset-renditions.png)

1. Välj **[!UICONTROL original]**. När en 3D-resurs publiceras (eller&quot;aktiveras&quot;) **[!UICONTROL URL]** visas i det nedre vänstra hörnet av sidan om alla följande 3D-resursvillkor uppfylls:
...
Använd följande två metoder för att publicera Dynamic Media 3D-resurser om du gör det *not* använd Experience Manager som WCM.
