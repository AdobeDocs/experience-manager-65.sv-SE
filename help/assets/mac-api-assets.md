...
Mer information finns i Stöd för [innehållsfragment i AEM Assets HTTP API](/help/assets/assets-api-content-fragments.md).
...
Mer information om element i innehållsfragment finns i Stöd för [innehållsfragment i AEM Assets HTTP API](/help/assets/assets-api-content-fragments.md#content-fragments).
...
Skapar en DAM-resurs på den angivna sökvägen med den angivna filen. Om * anges i stället för ett nodnamn kommer serverleten att använda parameternamnet eller filnamnet som nodnamn.
