---
title: Ljuslåda som ditt personliga bildgalleri i [!DNL Adobe Experience Manager Assets].
...
1. Dra resurserna till **[!UICONTROL Drop in Lightbox]** zonen. Släpp när släppzonen blir aktiv och etiketten ändras till **[!UICONTROL Drop to Add]**.

   ![add_to_lightbox](assets/add_to_lightbox.png)

1. Klicka på i dialogrutan **[!UICONTROL Add]** och stäng den sedan för att slutföra processen. De valda resurserna läggs till i ljuslådan.
...
1. Klicka på **[!UICONTROL Remove]** för att bekräfta borttagningsåtgärden i dialogrutan. Resurserna tas bort från ljuslådan.
