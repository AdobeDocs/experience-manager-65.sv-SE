...
Se [Referens för regeluppsättning](https://experienceleague.adobe.com/sv/docs/dynamic-media-developer-resources/image-serving-api/image-serving-api/rule-set-reference/c-rule-set-reference).
...
Se [Adobe Dynamic Media Classic-datorprogrammet för inloggningsinformation](https://experienceleague.adobe.com/sv/docs/dynamic-media-classic/using/getting-started/signing-out#sign-in-dmc-app).
...
1. Logga in på ditt [Dynamic Media Classic-datorprogram](https://experienceleague.adobe.com/sv/docs/dynamic-media-classic/using/getting-started/signing-out#sign-in-dmc-app).
