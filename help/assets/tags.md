...
* Stödet för videospårning är begränsat till enbart huvuduppspelningsspårning, vilket beskrivs i [Spårningsöversikt](https://experienceleague.adobe.com/sv/docs/media-analytics/using/tracking/track-core-overview). Speciellt stöds inte QoS, Ads, Chapter/Segments eller Errors tracking.
...
Se [Dataelement](https://experienceleague.adobe.com/sv/docs/experience-platform/tags/ui/data-elements).
...
Se [Regler](https://experienceleague.adobe.com/sv/docs/experience-platform/tags/ui/rules).
...
Stödet för videospårning är för närvarande begränsat till enbart huvuduppspelningsspårning, vilket beskrivs i [Spårningsöversikt](https://experienceleague.adobe.com/sv/docs/media-analytics/using/tracking/track-core-overview). Speciellt stöds inte QoS, Ads, Chapter/Segments eller Errors tracking.
...
I referenshandboken för [Dynamiska medievisningsprogram](https://experienceleague.adobe.com/sv/docs/dynamic-media-developer-resources/library/viewers-aem-assets-dmc/c-html5-s7-aem-asset-viewers#viewers-aem-assets-dmc) finns en lista över händelser som stöds av varje visningsprogramtyp. Gå till den specifika visningsprogramsektionen och välj sedan underavsnittet Stöd för Adobe Analytics-spårning. För närvarande dokumenterar inte referenshandboken för Dynamic Media Viewer händelseargument.
...
Se även [Skapa en taggegenskap](https://experienceleague.adobe.com/sv/docs/platform-learn/implement-mobile-sdk/initial-configuration/configure-tags).
...
Se [Adobe Experience Cloud Identity Service-tillägg](https://experienceleague.adobe.com/sv/docs/experience-platform/tags/extensions/client/id-service/overview).
