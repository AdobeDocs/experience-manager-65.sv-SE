...
Se [referenshandboken för Dynamic Media Viewer](https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/library/viewers-aem-assets-dmc/c-html5-s7-aem-asset-viewers.html#viewers-aem-assets-dmc) för en lista över händelser som stöds av varje visningsprogramtyp. Gå till ett specifikt visningsprogramavsnitt och välj sedan Support för underavsnittet Adobe Analytics tracking. Referenshandboken för Dynamic Media Viewer dokumenterar för närvarande inte händelseargument.
...
* I redigeraren Ange variabler för Adobe Analytics-tillägget markerar du väljarikonen **[!UICONTROL Data Element]** (tre skiktade diskar) för att öppna dialogrutan Markera dataelement och väljer sedan ett dataelement från den.
...
1. Börja med att gå till Adobe Analytics från Experience Cloud [startsidan](https://experience.adobe.com/#/home). På menyraden väljer du ikonen **[!UICONTROL Solutions]** (en tabell med tre punkter) i det övre högra hörnet av sidan och sedan **[!UICONTROL Analytics]**.
...
1. På sidan **[!UICONTROL Report Suite Manager]** väljer du rätt rapport och navigerar sedan till **[!UICONTROL Edit Settings]** > **[!UICONTROL Traffic]** > **[!UICONTROL Traffic Variables]** i verktygsfältet.
...
1. Börja med att gå till Experience Platform-taggar från Experience Cloud [startsidan](https://experience.adobe.com/#/home). På menyraden väljer du ikonen **[!UICONTROL Solutions]** (tre gånger tre prickar) i det övre högra hörnet av sidan och sedan **[!UICONTROL Tags]**.
...
(Endast i demonstrationssyfte används Report Suite-ID:t för **[!UICONTROL DynamicMediaViewersExtensionDoc]** Report Suite i följande skärmbilder. Detta ID skapades och användes i [Välj en rapportsvit](#selecting-a-report-suite) tidigare.)
...
1. I författaren till Experience Manager väljer du ikonen **[!UICONTROL Tools]** (hammer) och går sedan till **[!UICONTROL Security]** > **[!UICONTROL Adobe IMS Configurations]**.
...
1. Om du vill hämta en fil med en offentlig nyckel (*.crt) till ditt lokala system väljer du **[!UICONTROL Download Public Key]**.
   ...
   >[!NOTE]
   >
   >***lämna*** sidan **[!UICONTROL Adobe IMS Technical Account Configuration]** öppen; ***stäng inte*** sidan och ***välj inte*** Nästa. Du kommer att gå tillbaka till den här sidan senare i stegen.
...
1. I författaren till Experience Manager, nära det övre vänstra hörnet, väljer du ikonen **[!UICONTROL Tools]** (hammer) och går sedan till **[!UICONTROL Cloud Services]** > **[!UICONTROL Experience Platform Tags Configurations]**.
...
Mer information om hur du konfigurerar molnkonfigurationen för Experience Platform Tags finns i [Integrera Experience Manager med Experience Platform-taggar via [!DNL Adobe I/O]](https://experienceleague.adobe.com/docs/experience-manager-learn/sites/integrations/experience-platform-launch/overview.html).
