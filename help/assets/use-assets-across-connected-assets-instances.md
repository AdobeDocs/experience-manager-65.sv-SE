...
* För [!DNL Adobe Experience Manager]-distributionstyper uppfylls ett av villkoren. [!DNL Experience Manager] 6.5  [!DNL Assets] fungerar med  [!DNL Experience Manager] som Cloud Service. Mer information om hur den här funktionen fungerar i [!DNL Experience Manager as a Cloud Service] finns i [Anslutna resurser i Experience Manager som en Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/admin/use-assets-across-connected-assets-instances.html).
...
## Begränsningar och bästa praxis {#tips-and-limitations}
