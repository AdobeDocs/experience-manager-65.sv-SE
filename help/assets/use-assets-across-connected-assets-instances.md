...
* Ett av villkoren som stöds är uppfyllt för [!DNL Adobe Experience Manager] distributionstyper. [!DNL Experience Manager] 6.5 [!DNL Assets] fungerar med [!DNL Experience Manager] som Cloud Service. Mer information om hur den här funktionen fungerar i [!DNL Experience Manager as a Cloud Service]finns i Funktionen [Anslutna resurser i Experience Manager som en Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/assets/admin/use-assets-across-connected-assets-instances.html).
...
* **Bildformat**: De format som stöds av [bildkomponenten](https://experienceleague.adobe.com/docs/experience-manager-core-components/using/components/image.html) . [!DNL Dynamic Media] bilder stöds inte.
...
1. Lägg till [!DNL Sites] distributionen som en av **[!UICONTROL Allowed Origins]** i fjärrkonfigurationen [!DNL Assets'] av CORS.
   ...
   1. Om du vill skapa en CORS-konfiguration för [!DNL Sites] distribution klickar du på Lägg till ![alternativikon](assets/do-not-localize/assets_add_icon.png) bredvid **[!UICONTROL Adobe Granite Cross-Origin Resource Sharing Policy]**.
...
1. En Sites-författare meddelas om en resurs hämtas asynkront och om en hämtningsåtgärd misslyckas. Under eller efter redigeringen kan författare se detaljerad information om hämtningsåtgärder och fel i användargränssnittet för [asynkrona jobb](/help/sites-administering/asynchronous-jobs.md).
