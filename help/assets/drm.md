...
1. Klicka på **[!UICONTROL Publish]** i verktygsfältet. Om du inte ser **Publish** i verktygsfältet klickar du på **[!UICONTROL More]** i verktygsfältet och letar upp **[!UICONTROL Publish]** ![publiceringsalternativet](assets/do-not-localize/publish-globe.png) .
