...
1. Tryck på **[!UICONTROL Manage Publication]** i verktygsfältet. Tryck på ellipsikonen i verktygsfältet så att du kan öppna **[!UICONTROL Manage Publication]**.
