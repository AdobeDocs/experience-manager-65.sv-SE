...
>[!NOTE]
>
>Kunderna måste använda det CDN (Content Deliver Network) som medföljer Adobe Experience Manager Dynamic Media för att kunna använda HTTP/2-leverans av innehåll.
