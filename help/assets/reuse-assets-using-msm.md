...
| AEM 6.4 | [Klicka här](https://experienceleague.adobe.com/docs/experience-manager-64/assets/using/reuse-assets-using-msm.html?lang=en) |
...
Använd MSM för [!DNL Assets], installera minst [!DNL Experience Manager] 6.5 Service Pack 1. Mer information finns i [versionsinformation om det senaste Service Pack-meddelandet](/help/release-notes/release-notes.md).
...
|---|---|---|
| [!UICONTROL References] järnväg | Synkronisera snabbt när du redan har markerat källan. | Se [Snabbåtgärder från referensfältet för källan](#refrailsource) |
