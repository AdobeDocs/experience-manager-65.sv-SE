...
Du *måste* redigera följande dynamiska mediainställningar genom att trycka på **[!UICONTROL Edit]** -ikonen i komponenten och sedan **[!UICONTROL Dynamic Media Settings.]**
