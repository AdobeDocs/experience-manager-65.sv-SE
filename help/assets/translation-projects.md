...
Om du vill skapa en språkkopia utlöser du ett av följande språkkopieringsarbetsflöden som finns under referenslinjen i användargränssnittet för [!DNL Experience Manager].
...
1. Navigera till källmappen som innehåller oöversatta resurser i gränssnittet [!DNL Assets].
...
1. I gränssnittet för [!DNL Assets] väljer du den källmapp där du lade till en resurs.
1. Öppna rutan **[!UICONTROL References]** och klicka på **[!UICONTROL Language Copies]** under **[!UICONTROL Copies]** för att visa listan över språkkopior.
...
1. Navigera till användargränssnittet för [!DNL Assets] och öppna sidan Egenskaper för var och en av de översatta resurserna för att visa översatta metadata.
...
1. I gränssnittet för [!DNL Assets] väljer du den källmapp där du lade till en resursmapp.
1. Öppna **[!UICONTROL References pane]** och klicka på **[!UICONTROL Language Copies]** under **[!UICONTROL Copies]** för att visa listan över språkkopior.
...
1. Klicka på ellipsen längst ned i plattan **[!UICONTROL Translation Job]**. Från listan med resurser på sidan **[!UICONTROL Translation Job]** kan du tydligt visa den tillfälliga plats där den översatta versionen av resursen lagras.
