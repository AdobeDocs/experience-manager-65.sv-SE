...
Den här funktionen visar aktivitetsloggar för resurser på tidslinjen. Om du utför någon av följande resursrelaterade åtgärder i Adobe Experience Manager Assets uppdaterar funktionen för aktivitetsströmmen tidslinjen så att den återspeglar aktiviteten.
