...
* [Använd variabeln](/help/sites-developing/using-variables-in-aem-workflows.md#use-a-variable) i eller Dela och Gå till AEM arbetsflödessteg för att definiera ett uttryck för att fatta beslut om routning. Du kan också använda variabler i alla AEM Forms arbetsflödessteg.
...
Alla AEM Forms arbetsflödessteg har stöd för variabler. Mer information finns i [Forms-centrerat arbetsflöde i OSGi](/help/forms/using/aem-forms-workflow-step-reference.md).
