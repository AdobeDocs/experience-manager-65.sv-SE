...
* [Skapa en variabel](/help/sites-developing/using-variables-in-aem-workflows.md#create-a-variable) av en datatyp baserat på den informationstyp som du vill lagra i den.
...
* [Använd variabeln](/help/sites-developing/using-variables-in-aem-workflows.md#use-a-variable) i arbetsflödena ELLER Dela och Gå till AEM för att definiera ett uttryck för att fatta beslut om routning. Du kan också använda variabler i alla arbetsflöden i AEM Forms.
...
* **Komplexa datatyper**: [XML](https://docs.oracle.com/javase/8/docs/api/org/w3c/dom/Document.html) och [JSON](https://static.javadoc.io/com.google.code.gson/gson/2.3/com/google/gson/JsonObject.html)
...
Mer information finns i Regelredigerare för [anpassade formulär](/help/forms/using/rule-editor.md).
...
I det här exemplet använder du [exempel 2](/help/sites-developing/using-variables-in-aem-workflows.md#example2) för att ange värdet för variabeln **totalvärde** innan du definierar routningsuttrycket. Gren 1 är aktiv om värdet för variabeln **total value** är större än 50000. På samma sätt kan du definiera en regel som gör grenen 2 aktiv om värdet för variabeln **total value** är mindre än 50000.
...
Alla arbetsflödessteg i AEM Forms har stöd för variabler. Mer information finns i [Formulärorienterat arbetsflöde i OSGi](/help/forms/using/aem-forms-workflow-step-reference.md).
...
Information om API:er för ytterligare komplexa variabeldatatyper som är tillgängliga i AEM Forms-arbetsflöden finns i [Variabler i AEM Forms-arbetsflöden](/help/forms/using/variable-in-aem-workflows.md).
...
1. Tryck på ikonen ![](https://helpx.adobe.com/content/dam/help/images/en/edit.png) (Redigera) bredvid variabelnamnet som du vill redigera.
1. Redigera variabelinformationen och tryck på ![](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/using/chart-component/Done_Icon.png) för att spara ändringarna. Du kan inte redigera fälten **[!UICONTROL Namn]** och **[!UICONTROL Typ]** för en variabel.
...
1. Tryck för ![](https://helpx.adobe.com/content/dam/help/en/experience-manager/6-4/forms/using/chart-component/Done_Icon.png) att bekräfta och ta bort variabeln.
