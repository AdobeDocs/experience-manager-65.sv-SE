...
Om du vill spara data från MD5-tjänsten på jsontest.com-webbplatsen använder du proceduren i [Skapa ett ContextHub Store](/help/sites-developing/ch-configuring.md#creating-a-contexthub-store) med följande egenskaper:
...
Använd proceduren i [Lägga till en gränssnittsmodul](#adding-a-ui-module) för att lägga till gränssnittsmodulen i ett befintligt användargränssnittsläge, till exempel exemplet UI-läge (Perona UI Mode). Använd följande egenskapsvärden för UI-modulen:
