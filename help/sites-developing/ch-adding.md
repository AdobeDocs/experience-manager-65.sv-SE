...
* Först [geolokalisering](ch-samplestores.md#contexthub-geolocation-sample-store-candidate) används för att fastställa användarens latitud.
...
Det finns ett antal alternativ för felsökning av ContextHub, bland annat att generera loggar. Se [ContextHub konfigureras för mer information.](ch-configuring.md#logging-debug-messages-for-contexthub)
