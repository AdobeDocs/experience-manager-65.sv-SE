...
[Frågebyggaren](/help/sites-developing/querybuilder-api.md) är ett enkelt sätt att fråga innehållsdatabasen. CQ levereras med en uppsättning prediktiva utvärderare som hjälper dig att hantera dina data.
