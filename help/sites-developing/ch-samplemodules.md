...
I följande exempel konfigureras användargränssnittsmodulen contexthub.base så att den visar information från ett [contexthub.emulators](/help/sites-developing/ch-samplestores.md#granite-emulators-sample-store-candidate) -arkiv. Objektet visar hur du hämtar data från arkivet med hjälp av den nyckel som `template` `storeMapping` objektet upprättar.
...
Gränssnittsmodulen contexthub.browserinfo visar information om klientens webbläsare och operativsystem. Information hämtas från surferinfo store, baserat på [contexthub.surferinfo](/help/sites-developing/ch-samplestores.md#contexthub-surferinfo-sample-store-candidate) store-kandidaten.
