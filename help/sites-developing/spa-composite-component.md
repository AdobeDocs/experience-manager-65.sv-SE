...
* Du har en fungerande extern React-app [som kan redigeras i AEM.](spa-edit-external.md)
* Appen React läses in i AEM [med komponenten RemotePage.](spa-remote-page.md)
...
1. Lägg till skapade `wknd-spa/components/imagecard` till de tillåtna komponenterna för behållarkomponenten [i sidmallen.](/help/sites-authoring/templates.md)
