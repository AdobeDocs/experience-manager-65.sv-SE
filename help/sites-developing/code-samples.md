...
Adobe Consulting Services-teamet har genererat ett antal Adobe Experience Manager (AEM)-kodexempel. Exemplen är väl kommenterade koddelar som hjälper AEM utvecklare att förstå de viktigaste byggstenarna i AEM. Proverna finns här: [https://adobe-consulting-services.github.io/acs-aem-samples/](https://adobe-consulting-services.github.io/acs-aem-samples/).
