...
* **[Övertäckningar](/help/sites-developing/overlays.md)** av resurser med [konfigurerade sökvägar](/help/sites-developing/overlays.md#configuring-the-search-paths).
