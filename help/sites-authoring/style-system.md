...
>[!CAUTION]
>
>CSS-klasserna (och eventuell nödvändig JavaScript) som konfigurerats som formategenskaper för en komponents policy måste distribueras som [Klientbibliotek](/help/sites-developing/clientlibs.md) till jobbet.
