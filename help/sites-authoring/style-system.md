...
1. Den AEM utvecklaren placerar angiven CSS (och JS som tillval) i en [Klientbibliotek](/help/sites-developing/clientlibs.md) och använder den.
...
>[!CAUTION]
>
>CSS-klasserna (och eventuell nödvändig JavaScript) som konfigurerats som formategenskaper för en komponents policy måste distribueras som [Klientbibliotek](/help/sites-developing/clientlibs.md) för att kunna arbeta.
